...
def main():
    ...
    feeds = deployer.deploy(ChainlinkFeedsRegistry, publish_source=True, {"gas_price": gas_strategy})
    toBytes32 = feeds.stringToBytes32

    feeds.addEthFeed(toBytes32("BTC"), "0x2431452A0010a43878bF198e170F6319Af6d27F4", {"gas_price": gas_strategy})
    feeds.addUsdFeed(toBytes32("ETH"), "0x8A753747A1Fa494EC906cE90E9f37563A8AF630e", {"gas_price": gas_strategy})
    feeds.addUsdFeed(toBytes32("LINK"), "0xd8bD0a1cB028a31AA859A21A3758685a95dE4623", {"gas_price": gas_strategy})
    feeds.addUsdFeed(toBytes32("SNX"), "0xE96C4407597CD507002dF88ff6E0008AB41266Ee", {"gas_price": gas_strategy})
